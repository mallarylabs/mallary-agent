...
| Instagram | `instagram` | `post_type`, `shareToFeed` for Reel feed placement, and `trialParams.graduationStrategy` for Trial Reels. Media `thumbnail_url` sets video/Reels covers. |
