...
- includes read-only command reference, explicit-request write examples, payload shapes, and platform notes
...
# Test without OAuth or an API key (should fail for authenticated commands)
